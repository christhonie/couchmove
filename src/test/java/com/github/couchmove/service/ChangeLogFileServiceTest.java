...
public class ChangeLogFileServiceTest {
    ...
    public void should_fetch_changeLogs() throws IOException {
        List<ChangeLog> changeLogs = Stream.of(
                ChangeLog.builder()
                        ...
                        .checksum("f9e6f785874844b1962db6778d509d76034eeda6d67a2c3e53f7de1e2c580af2")
                        .checksumLegacy("1a417b9f5787e52a46bc65bcd801e8f3f096e63ebcf4b0a17410b16458124af3")
                        .build(),
                ChangeLog.builder()
                        .type(Type.DOCUMENTS)
                        ...
                        .checksum("7893debe05618746ec8e6d7975f060f63c41536f4e3502bbb290010f336303fc")
                        .checksumLegacy("99a4aaf12e7505286afe2a5b074f7ebabd496f3ea8c4093116efd3d096c430a8")
                        .build(),
                ChangeLog.builder()
                        ...
                        .version("1")
                        .description("user")
                        .checksum("059c12d6baf8fd945fbd412632cab1bf94e97cc37e965a1a7bd97c094ebe967a")
                        .checksumLegacy("22df7f8496c21a3e1f3fbd241592628ad6a07797ea5d501df8ab6c65c94dbb79")
                        .build(),
                ChangeLog.builder()
                        .type(Type.FTS)
                        .script("V2__name.fts")
                        ...
                        .checksumLegacy ("6ef9c3cc661804f7f0eb489e678971619a81b5457cff9355e28db9dbf835ea0a")
                        .build(),
                ChangeLog.builder()
                        .type(Type.EVENTING)
                        ...
                        .checksumLegacy("d088945774720c9fd625394dca7528dd88eba8a12378ad312117eca3c3f8f645")
                        .build())
    ...
    public void should_fetch_files_with_same_version() throws IOException {
        ...
        assertThat(results)
                .usingRecursiveFieldByFieldElementComparatorIgnoringFields("checksum", "checksumLegacy", "description")
